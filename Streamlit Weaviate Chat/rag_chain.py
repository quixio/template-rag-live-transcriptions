...
# from splitter import split_documents  MC: Commenting out for now, don't need
# from vector_store import create_vector_db MC: Commenting out for now, don't need
...
def main():
    ...
    # retriever = vs.as_retriever() MC: Commenting out for now, don't need

    output_parser = StrOutputParser()
    chain = basic_chain(model, prompt)
    base_chain = chain | output_parser
    # rag_chain = make_rag_chain(model, retriever) | output_parser MC: Commenting out for now, don't need
    ...
    for q in questions:
        ...
        # print("* RAG:\n", rag_chain.invoke(q)) MC: Commenting out for now, don't need
